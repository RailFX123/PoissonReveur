...
public class PrintVisitor implements Visitor {
    ...
    public void visit(Declarations decl) {
        if (decl.getList() != null) {
            decl.getList().forEach((varDeclList) -> {
                varDeclList.getList().forEach((varDecl) -> {
                    System.out.println(varDecl.getId().getName() + ": " + varDecl.getType());
                });
            });
        }
        System.out.println();
    ...
    @Override
    public void visit(StringLiteral aThis) {
        System.out.print(aThis.getValue());
    }

    @Override
    public void visit(StringType stringT) {
        System.out.println("String");
    }

    @Override
    public void visit(StringArrayType aThis) {
        System.out.println("String []");
    }
